...
//		Client c2 = new Client("Rouget", "Bernard", new Date(), "avenue des jambons", "bernardrouget@yahoo.fr",
...
//		Employe ep1 = new Employe("Cook", "Tim", new Date(), "Silicon Valley", "timcook@apple.com", "0989", new Date(), 25000.0);
//		logger.info(ep1.toString());
//		service.addPersonne(ep1, 1L);
//		assertNotNull(service.getPersonneId(4L));
		
//		Contractuel ctl1 = new Contractuel("Chichenko", "Nicolas", new Date(), "StPierre", "Chichenko.niko@gmail.com", "06123456098", new Date(), 1500.0, 200.0);
//		logger.info(ctl1.toString());
//		service.addPersonne(ctl1, 1L);
//		assertNotNull(service.getPersonneId(5L));
		
//		Saisonnier san1 = new Saisonnier("Vernon", "Roche", new Date(), "Midkemia", "vernon.roche@striesbleu.fl", "67578966", new Date(), 30000.0, new Date());
...
//		 logger.info("Nouveau nom : "+ service.getPersonneId(1L).getNomPersonne());
//	 }
